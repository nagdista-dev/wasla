...
export default function SearchOverlay({ isOpen, onClose, channels, feedItems }: SearchOverlayProps) {
  ...
  const results = channels.flatMap((ch) => {
    ...
    const entries: { channel: Channel; video?: typeof video; loading?: boolean; matchType: 'channel' | 'video' }[] = [];
