const ar: Record<string, string> = {
  ...
  'videoPage.tabsLabel': 'أقسام صفحة الفيديو',
  'videoPage.videoInformation': 'الوصف',
   'videoPage.learning': 'الترجمة النصية (CC)',
  'videoPage.subtitles': 'الترجمة النصية',
  'videoPage.currentSubtitle': 'الترجمة الحالية',
  'videoPage.autoGenerated': 'مولدة تلقائياً',
  'videoPage.learningPrompt': 'اختر التعلم لتحميل الترجمة النصية.',
  'videoPage.learningUnavailable': 'الترجمة النصية غير متوفرة',
   'videoPage.tryAgain': 'حاول مرة أخرى',
   'videoPage.loadingCaptions': 'جارٍ تحميل الترجمة...',
   'videoPage.selectLanguage': 'اختر لغة الترجمة',
   'videoPage.dualSubtitles': 'مزدوج',
  ...
  'videoPage.addTimestamp': 'إضافة طابع زمني',
  'videoPage.timestampNote': 'ملاحظة عند {time}',
  'videoPage.noNotes': 'لا توجد ملاحظات بعد',
   'videoPage.deleteNote': 'حذف الملاحظة',
   'videoPage.deleteAll': 'حذف الكل',
