const en = {
  ...
  'videoPage.tabsLabel': 'Video page sections',
  'videoPage.videoInformation': 'Description',
   'videoPage.learning': 'CC Subtitles',
  'videoPage.subtitles': 'Subtitles',
  'videoPage.currentSubtitle': 'Current subtitle',
  'videoPage.autoGenerated': 'auto-generated',
  'videoPage.learningPrompt': 'Select Learning to load subtitles.',
  'videoPage.learningUnavailable': 'No subtitles available',
   'videoPage.tryAgain': 'Try Again',
   'videoPage.loadingCaptions': 'Loading captions...',
   'videoPage.selectLanguage': 'Select caption language',
   'videoPage.dualSubtitles': 'Dual',
   ...
   'videoPage.addTimestamp': 'Add Timestamp',
   'videoPage.timestampNote': 'Note at {time}',
   'videoPage.noNotes': 'No notes yet',
   'videoPage.deleteNote': 'Delete note',
   'videoPage.deleteAll': 'Delete all',
