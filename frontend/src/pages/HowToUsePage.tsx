...
export default function HowToUsePage() {
  ...
  return (
    <div className="min-h-screen dark:bg-dark-navy">
      ...
      <div className="lg:hidden sticky top-16 z-30 bg-white/80 dark:bg-dark-navy/80 backdrop-blur-md border-b border-gray-200 dark:border-gray-800 px-4 py-3 flex items-center justify-between">
        <span className="font-bold text-sm text-gray-900 dark:text-white">{language === 'ar' ? 'التوثيق والدليل' : 'Documentation'}</span>
        <button onClick={() => setShowMobileMenu(!showMobileMenu)} className="p-2 rounded-lg bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors">
          {showMobileMenu ? <X className="h-5 w-5" /> : <Menu className="h-5 w-5" />}
        </button>
      </div>

      <div className="mx-auto w-full max-w-[1440px] 2xl:max-w-[1600px] px-4 sm:px-4 lg:px-6 py-6 flex flex-col lg:flex-row gap-8 lg:gap-12 relative">
        
        {/* Sidebar Navigation */}
        <aside className={`lg:w-64 shrink-0 lg:sticky lg:top-24 lg:self-start transition-all duration-300 z-30 ${showMobileMenu ? 'block fixed inset-0 top-16 bg-white dark:bg-dark-navy p-6 overflow-y-auto' : 'hidden lg:block'}`}>
        ...
        {/* Main Content */}
        <main className="flex-1 w-full min-w-0 pb-16 sm:pb-32">
          
          {/* 1. HERO SECTION */}
          <section id="hero" className="mb-16 sm:mb-24 pt-4 lg:pt-10">
            <div className="rounded-3xl bg-gradient-to-br from-brand-pink via-brand-coral to-brand-orange p-8 sm:p-12 text-white shadow-2xl relative overflow-hidden">
              <div className="absolute top-0 right-0 p-12 opacity-10 pointer-events-none">
                <Film className="w-32 h-32 sm:w-64 sm:h-64" />
              </div>
          ...
          {/* 2. WHAT IS WASLA */}
          <section id="about" className="scroll-mt-24 mb-16 sm:mb-24">
            <div className="flex items-center gap-3 mb-8">
              <Info className="h-8 w-8 text-brand-coral" />
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white">{str(SECTIONS[0])}</h2>
            </div>
            <div className="bg-white dark:bg-dark-navy rounded-xl p-6 sm:p-8 shadow-sm ring-1 ring-gray-200 dark:ring-gray-700">
              ...
              <div className="grid sm:grid-cols-2 gap-6">
                <div className="p-5 rounded-xl bg-gray-50 dark:bg-gray-800/50 ring-1 ring-gray-200 dark:ring-gray-700">
                  <h3 className="font-bold text-lg mb-2 flex items-center gap-2 text-gray-900 dark:text-white"><FolderHeart className="h-5 w-5 text-brand-coral" /> {language === 'ar' ? 'التنظيم' : 'Organization'}</h3>
                ...
                <div className="p-5 rounded-xl bg-gray-50 dark:bg-gray-800/50 ring-1 ring-gray-200 dark:ring-gray-700">
                  <h3 className="font-bold text-lg mb-2 flex items-center gap-2 text-gray-900 dark:text-white"><Shield className="h-5 w-5 text-brand-coral" /> {language === 'ar' ? 'الخصوصية' : 'Privacy-First'}</h3>
                  <p className="text-gray-600 dark:text-gray-400 text-sm">
          ...
          {/* 3. QUICK START */}
          <section id="quickstart" className="scroll-mt-24 mb-16 sm:mb-24">
            <div className="flex items-center gap-3 mb-8">
              <Zap className="h-8 w-8 text-brand-coral" />
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white">{str(SECTIONS[1])}</h2>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                <div key={step.i} className="relative bg-white dark:bg-dark-navy p-6 rounded-xl shadow-sm ring-1 ring-gray-200 dark:ring-gray-700 group hover:shadow-md transition-shadow">
          ...
          {/* 4. FEATURE SHOWCASE */}
          <section id="features" className="scroll-mt-24 mb-16 sm:mb-24">
            <div className="flex items-center gap-3 mb-8">
              <LayoutTemplate className="h-8 w-8 text-brand-coral" />
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white">{str(SECTIONS[2])}</h2>
            </div>

            <div className="space-y-8">
              {/* Feature 1 */}
              <div className="bg-white dark:bg-dark-navy rounded-xl overflow-hidden shadow-sm ring-1 ring-gray-200 dark:ring-gray-700 flex flex-col sm:flex-row">
                <div className="p-8 sm:w-1/3 bg-gray-50 dark:bg-gray-800/30 flex flex-col justify-center border-b sm:border-b-0 sm:border-e border-gray-100 dark:border-gray-800">
                  ...
                  <h3 className="text-xl font-bold mb-2 text-gray-900 dark:text-white">{language === 'ar' ? 'إدارة القنوات' : 'Channel Management'}</h3>
                ...
                <div className="p-8 sm:w-2/3">
                  <ul className="space-y-3">
                    <li className="flex items-center gap-2"><CheckCircle2 className="h-5 w-5 text-brand-coral" /> {language === 'ar' ? 'إضافة قناة عن طريق الرابط أو المُعرّف' : 'Add channel by URL or Handle'}</li>
                    <li className="flex items-center gap-2"><CheckCircle2 className="h-5 w-5 text-brand-coral" /> {language === 'ar' ? 'تعديل اسم القناة المخصص' : 'Edit custom channel names'}</li>
                    <li className="flex items-center gap-2"><CheckCircle2 className="h-5 w-5 text-brand-coral" /> {language === 'ar' ? 'تحديد قنوات مفضلة للوصول السريع' : 'Mark channels as favorites for quick access'}</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="bg-white dark:bg-dark-navy rounded-xl overflow-hidden shadow-sm ring-1 ring-gray-200 dark:ring-gray-700 flex flex-col sm:flex-row">
                <div className="p-8 sm:w-1/3 bg-gray-50 dark:bg-gray-800/30 flex flex-col justify-center border-b sm:border-b-0 sm:border-e border-gray-100 dark:border-gray-800">
                  <Share2 className="h-10 w-10 text-brand-coral mb-4" />
                  <h3 className="text-xl font-bold mb-2 text-gray-900 dark:text-white">{language === 'ar' ? 'المشاركة والاستيراد' : 'Sharing & Importing'}</h3>
                  <p className="text-sm text-gray-500 dark:text-gray-400">
                ...
                <div className="p-8 sm:w-2/3">
                  <ul className="space-y-3">
                    <li className="flex items-center gap-2"><CheckCircle2 className="h-5 w-5 text-brand-coral" /> {language === 'ar' ? 'إنشاء روابط مشاركة للأقسام' : 'Generate shareable links for categories'}</li>
                    <li className="flex items-center gap-2"><CheckCircle2 className="h-5 w-5 text-brand-coral" /> {language === 'ar' ? 'استيراد تلقائي للقنوات المشتركة' : 'Automatically import shared channels'}</li>
                    <li className="flex items-center gap-2"><CheckCircle2 className="h-5 w-5 text-brand-coral" /> {language === 'ar' ? 'دمج القنوات بدون تكرار' : 'Merge channels without duplicates'}</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="bg-white dark:bg-dark-navy rounded-xl overflow-hidden shadow-sm ring-1 ring-gray-200 dark:ring-gray-700 flex flex-col sm:flex-row">
                <div className="p-8 sm:w-1/3 bg-gray-50 dark:bg-gray-800/30 flex flex-col justify-center border-b sm:border-b-0 sm:border-e border-gray-100 dark:border-gray-800">
                  <Play className="h-10 w-10 text-brand-coral mb-4" />
                  <h3 className="text-xl font-bold mb-2 text-gray-900 dark:text-white">{language === 'ar' ? 'مشغل الفيديو والتتبع' : 'Video Player & Tracking'}</h3>
                  <p className="text-sm text-gray-500 dark:text-gray-400">
                ...
                <div className="p-8 sm:w-2/3">
                  <ul className="space-y-3">
                    <li className="flex items-center gap-2"><CheckCircle2 className="h-5 w-5 text-brand-coral" /> {language === 'ar' ? 'حفظ تلقائي لتقدم المشاهدة' : 'Auto-save watch progress'}</li>
                    <li className="flex items-center gap-2"><CheckCircle2 className="h-5 w-5 text-brand-coral" /> {language === 'ar' ? 'استئناف الفيديو من حيث توقفت' : 'Resume videos from where you left off'}</li>
                    <li className="flex items-center gap-2"><CheckCircle2 className="h-5 w-5 text-brand-coral" /> {language === 'ar' ? 'سجل مشاهدة كامل (Watch History)' : 'Complete Watch History'}</li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          {/* 5. PRO TIPS */}
          <section id="tips" className="scroll-mt-24 mb-16 sm:mb-24">
            <div className="flex items-center gap-3 mb-8">
              <Lightbulb className="h-8 w-8 text-brand-coral" />
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white">{str(SECTIONS[3])}</h2>
            </div>
            <div className="grid sm:grid-cols-2 gap-4">
              <div className="bg-white dark:bg-dark-navy p-5 rounded-xl shadow-sm ring-1 ring-gray-200 dark:ring-gray-700 border-l-4 border-l-brand-coral">
                <h3 className="font-bold text-lg mb-2 text-gray-900 dark:text-white">{language === 'ar' ? 'نظم المحتوى بنظام النيش' : 'Organize by Niche'}</h3>
              ...
              <div className="bg-white dark:bg-dark-navy p-5 rounded-xl shadow-sm ring-1 ring-gray-200 dark:ring-gray-700 border-l-4 border-l-brand-pink">
                <h3 className="font-bold text-lg mb-2 text-gray-900 dark:text-white">{language === 'ar' ? 'استخدم قوائم المشاهدة لاحقاً' : 'Use Watch Later'}</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400">
              ...
              <div className="bg-white dark:bg-dark-navy p-5 rounded-xl shadow-sm ring-1 ring-gray-200 dark:ring-gray-700 border-l-4 border-l-brand-yellow">
                <h3 className="font-bold text-lg mb-2 text-gray-900 dark:text-white">{language === 'ar' ? 'النسخ الاحتياطي الدوري' : 'Regular Backups'}</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400">
              ...
              <div className="bg-white dark:bg-dark-navy p-5 rounded-xl shadow-sm ring-1 ring-gray-200 dark:ring-gray-700 border-l-4 border-l-brand-orange">
                <h3 className="font-bold text-lg mb-2 text-gray-900 dark:text-white">{language === 'ar' ? 'الأقسام المشتركة للمجتمعات' : 'Shared Categories for Communities'}</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400">
          ...
          {/* 6. FAQ */}
          <section id="faq" className="scroll-mt-24 mb-16 sm:mb-24">
            <div className="flex items-center gap-3 mb-8">
              <HelpCircle className="h-8 w-8 text-brand-coral" />
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white">{str(SECTIONS[4])}</h2>
            </div>
            <div className="space-y-4">
              {FAQ_ITEMS.map((faq, idx) => (
                <div key={idx} className="bg-white dark:bg-dark-navy rounded-xl shadow-sm ring-1 ring-gray-200 dark:ring-gray-700 overflow-hidden transition-all duration-300">
                  <button
                    onClick={() => setOpenFaqIndex(openFaqIndex === idx ? null : idx)}
                    className="w-full flex items-center justify-between p-5 text-start font-bold focus:outline-none text-gray-900 dark:text-white"
                  >
                    <span>{str(faq.q)}</span>
          ...
          {/* 7. SHORTCUTS */}
          <section id="shortcuts" className="scroll-mt-24 mb-16 sm:mb-24">
            <div className="flex items-center gap-3 mb-8">
              <Keyboard className="h-8 w-8 text-brand-coral" />
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white">{str(SECTIONS[5])}</h2>
            </div>
            <div className="bg-white dark:bg-dark-navy p-6 rounded-xl shadow-sm ring-1 ring-gray-200 dark:ring-gray-700">
          ...
          {/* 8. PRIVACY */}
          <section id="privacy" className="scroll-mt-24 mb-16 sm:mb-24">
            <div className="flex items-center gap-3 mb-8">
              <Shield className="h-8 w-8 text-brand-coral" />
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white">{str(SECTIONS[6])}</h2>
            </div>
            <div className="bg-white dark:bg-dark-navy p-6 sm:p-8 rounded-xl shadow-sm ring-1 ring-gray-200 dark:ring-gray-700 flex flex-col sm:flex-row gap-6 items-start">
              <div className="p-4 bg-brand-coral/10 rounded-full shrink-0">
                <Shield className="h-10 w-10 text-brand-coral" />
              </div>
              <div>
          ...
          <section id="roadmap" className="scroll-mt-24 mb-10">
            <div className="flex items-center gap-3 mb-8">
              <RefreshCw className="h-8 w-8 text-brand-coral" />
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white">{str(SECTIONS[7])}</h2>
            </div>
            <div className="bg-white dark:bg-dark-navy p-6 sm:p-8 rounded-xl shadow-sm ring-1 ring-gray-200 dark:ring-gray-700">
              <div className="flex items-center justify-between border-b border-gray-100 dark:border-gray-800 pb-4 mb-6">
                ...
                <span className="px-3 py-1 bg-brand-coral/10 text-brand-coral rounded-full text-xs font-bold uppercase tracking-wide">Stable</span>
              </div>
              <h4 className="font-bold mb-4 text-gray-900 dark:text-white">{language === 'ar' ? 'ميزات قادمة في خارطة الطريق:' : 'Upcoming features in roadmap:'}</h4>
              <ul className="space-y-3">
